    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                   ...
                   <el-col :span="12">
                       <el-form-item class="select" v-if="type!='info'"  label="用户" prop="yonghuTypes">
                           <el-select v-model="ruleForm.yonghuTypes" placeholder="请选择用户">
                               <el-option
                       ...
                       <div v-else>
                           <el-form-item class="input" label="用户" prop="yonghuTypes">
                               <el-select v-model="ruleForm.yonghuTypes" placeholder="请选择用户" readonly>
                                   <el-option
                                           v-for="(item,index) in yonghuTypesSelectSearch"
                                           v-bind:key="index"
                                           :label="item.indexName"
                   ...
                   <el-col :span="12">
                       ...
                       <div v-else>
                        ...
                        <el-col :span="12">
                            <el-form-item class="date" v-if="type!='info'" label="上传时间" prop="riqi">
                                <el-date-picker
                                        format="yyyy 年 MM 月 dd 日"
                                        value-format="yyyy-MM-dd"
                                        v-model="ruleForm.shuangchuanTime"
                                        type="date"
                                        placeholder="上传时间">
                                </el-date-picker>
                            </el-form-item>
                            <div v-else>
                                <el-form-item class="input" v-if="ruleForm.shuangchuanTime" label="上传时间" prop="shuangchuanTime">
                                    <el-input v-model="ruleForm.shuangchuanTime"
                   ...
                   <el-col :span="12" v-if="1==2">
                       ...
                       <div v-else>
                        ...
                        <el-col :span="12">
                            <el-form-item class="date" v-if="type!='info'" label="创建时间" prop="riqi">
                                <el-date-picker
                                        format="yyyy 年 MM 月 dd 日"
                                        value-format="yyyy-MM-dd"
                                        v-model="ruleForm.wodewenjianTime"
                                        type="date"
                                        placeholder="创建时间">
                                </el-date-picker>
                            </el-form-item>
                            <div v-else>
                                <el-form-item class="input" v-if="ruleForm.wodewenjianTime" label="创建时间" prop="wodewenjianTime">
                                    <el-input v-model="ruleForm.wodewenjianTime"
