        ...
        >
            <el-row>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="账户" prop="username">
                              <el-input v-model="ruleForm.username"
                                        placeholder="账户" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                   ...
                   <el-col :span="12">
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="身份证号" prop="yonghuNumber">
                              <el-input v-model="ruleForm.yonghuNumber"
                                        placeholder="身份证号" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="身份证号" prop="yonghuNumber">
                                  <el-input v-model="ruleForm.yonghuNumber"
        ...
        data() {
            ...
            return {
                ...
                rules: {
                        ...
                        yonghuName: [
                        { required: true, message: '用户姓名  不能为空', trigger: 'blur' },
                    ],
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                                 ...
                                 if(o=='yonghuNumber'){
                                     this.ruleForm.yonghuNumber = obj[o];
                                     this.ro.yonghuNumber = true;
                                     continue;
                                 }
