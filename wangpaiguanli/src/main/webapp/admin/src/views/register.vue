  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(208, 163, 140, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 255, 255, 1);fontSize:28px;">网盘管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.password" autocomplete="off" placeholder="密码" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.yonghuName" class="input" type="text" placeholder="姓名">
			   </div>
			 </div> -->
			<el-form-item label="姓名" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   <div class="label">联系电话</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yonghuPhone" class="input" type="text" placeholder="联系电话">
			   </div>
			 </div> -->
			<el-form-item label="联系电话" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.yonghuPhone" autocomplete="off" placeholder="联系电话" type="text" />
			</el-form-item>
			
			<el-form-item label="邮箱" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.yonghuEmail" autocomplete="off" placeholder="邮箱" type="text" />
			</el-form-item>
			
			<el-form-item label="身份证" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.yonghuNumber" autocomplete="off" placeholder="身份证" type="text" />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
	  ...
	  if(`yonghu` == this.tableName && this.ruleForm.yonghuNumber&&(!this.$validate.isNumber(this.ruleForm.yonghuNumber))){
	    this.$message.error(`身份证应输入正确格式`);
	    return
	  }
                                                                                                                                                                                                                        this.$http({
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://localhost:8080/wangpaiguanli/upload/1.jpg");
		height: 100vh;
